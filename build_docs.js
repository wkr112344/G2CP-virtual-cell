...
const enChildren = [
  ...
  pc(""),
  new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun({ text: "Kairui Wei", bold: true, size: 26 })] }),
  ...
  p("Author contributions: K.W. conceived the study, implemented all code, conducted all experiments, and wrote the manuscript."),
  h2("References"),
...
const cnChildren = [
  ...
  pc(""),
  new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun({ text: "卫铠睿", bold: true, size: 26, font: "SimSun" })] }),
  new Paragraph({ alignment: AlignmentType.CENTER, children: [new TextRun({ text: "新疆医科大学临床医学本硕 2023-1 班，乌鲁木齐 830011", size: 22, font: "SimSun" })] }),
